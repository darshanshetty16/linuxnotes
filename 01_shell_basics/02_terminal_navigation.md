...
To move up one or ***Parent directory*** use cd .. command

<pre>$ cd .. </pre>

To go directly to your ***Home directory***, run cd ~ command

<pre>$ cd ~ </pre>

To clear all terminal screen and remove all previous commands and outputs,run clear command
<pre>$ clear </pre>
