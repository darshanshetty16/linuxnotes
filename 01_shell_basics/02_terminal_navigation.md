1.<strong>Print Current Working Directory</strong> <br>
Displays the full path of your current working Directory.
<pre> pwd </pre>

2.<strong>List Directory Contents</strong> <br>
...
clears terminal Windows 
<pre> clear </pre>

View Command History <br>
shows a number of commands you've recently typed
<pre> history </pre>
